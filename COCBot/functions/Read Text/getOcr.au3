...
;
Func getUpgradeCost1($x_start, $y_start)
	Return getOcrAndCapture("coc-upgrade1", $x_start, $y_start, 106, 22, True)
EndFunc   ;==>getUpgradeCost

Func getUpgradeCost2($x_start, $y_start)
	Return getOcrAndCapture("coc-upgrade2", $x_start, $y_start, 106, 22, True)
EndFunc   ;==>getUpgradeCost

Func getUpgradeCost3($x_start, $y_start)
	Return getOcrAndCapture("coc-upgrade3", $x_start, $y_start, 106, 22, True)
EndFunc   ;==>getUpgradeCost
;
