...
Func ReadConfig_Android()
	...
	$g_sUserGameClass = IniRead($g_sProfileConfigPath, "android", "UserAppActitivityName", $g_sUserGameClass)
		...
		$g_sAndroidGameDistributor = "Google" ; Default CoC Game Distributor, loaded from config.ini
		$g_sAndroidGamePackage = "com.supercell.clashofclans" ; Default CoC Game Package, loaded from config.ini
		$g_sAndroidGameClass = "com.supercell.titan.GameApp" ; Default CoC Game Class, loaded from config.ini
		$g_sUserGameDistributor = "Google" ; User Added CoC Game Distributor, loaded from config.ini
		$g_sUserGamePackage = "com.supercell.clashofclans" ; User Added CoC Game Package, loaded from config.ini
		$g_sUserGameClass = "com.supercell.titan.GameApp" ; User Added CoC Game Class, loaded from config.ini	
