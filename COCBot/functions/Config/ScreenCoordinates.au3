...
Global $aNoShield[4] = [455, 20, 0x464848, 15] ; Main Screen, charcoal pixel center of shield when no shield is present
Global $aHaveShield[4] = [455, 19, 0xF0F8FB, 15] ; Main Screen, Silver pixel top center of shield
Global $aHavePerGuard[4] = [455, 19, 0x5C38A2, 15] ; Main Screen, black pixel in sword outline top center of shield
...
Global $aIsAtkDarkElixirFull[4] = [745, 62 + $g_iMidOffsetY, 0x270D33, 10] ; Attack Screen DE Resource bar is full
Global $aIsDarkElixirFull[4] = [710, 102 + $g_iMidOffsetY, 0x270D33, 10] ; Main Screen DE Resource bar is full
Global $aIsGoldFull[4] = [661, 2 + $g_iMidOffsetY, 0xE7C00D, 10] ; Main Screen Gold Resource bar is Full
Global $aIsElixirFull[4] = [661, 52 + $g_iMidOffsetY, 0xC027C0, 10] ; Main Screen Elixir Resource bar is Full
...
Global Const $aIsAttackPage[4] = [58, 548 + $g_iBottomOffsetY, 0xcf0d0e, 20] ; red button "end battle" - left portion
